      ...
      Object.entries(activities).forEach(([name, details]) => {
              ...
              <div class="participants">
                ...
                <ul class="participants-list">
                  ${details.participants
                    .map(
                      (email) =>
                        `<li class="participant-item">${email}<button class="participant-remove" data-email="${email}" title="Remove participant">✕</button></li>`
                    )
                    .join("")}
                </ul>
              </div>
        ...
        activityCard.querySelectorAll(".participant-remove").forEach((button) => {
          button.addEventListener("click", async () => {
            ...
            await removeParticipant(name, participantEmail);
          });
        });
